...
export default function AdjacentPostCard({
  ...
  return (
    <Link href={`/posts/${path}`} className="relative w-full bg-black group max-h-56">
      <Image
        ...
        height={100}
      />
      <div className="absolute flex items-center justify-around w-full px-2 text-white -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
